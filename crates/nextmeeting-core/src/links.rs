    ...
    mod all_services {
        ...
        fn test_all_services_detected() {
            let cases: &[(&str, LinkKind)] = &[
                ...
                (
                    "https://stream.meet.google.com/stream/abc-123",
                    LinkKind::MeetStream,
                ),
                ...
                (
                    "https://teams.microsoft.com/l/meetup-join/19%3ameeting_abc@thread.v2/0?context=xyz",
                    LinkKind::Teams,
                ),
                ...
                (
                    "https://uberconference.com/room123",
                    LinkKind::UberConference,
                ),
                ("https://go.blizz.com/join/123", LinkKind::Blizz),
                (
                    "https://go.teamviewer.com/meet/123",
                    LinkKind::TeamViewerMeeting,
                ),
                ...
                (
                    "https://company.workplace.com/groupcall/123",
                    LinkKind::FacebookWorkplace,
                ),
                ("https://join.skype.com/abc123", LinkKind::Skype),
                (
                    "https://meet.lync.com/company/user/abc",
                    LinkKind::Skype4Biz,
                ),
                ("https://call.lifesizecloud.com/123456", LinkKind::Lifesize),
                ("https://www.youtube.com/watch?v=abc123", LinkKind::YouTube),
                (
                    "https://meetings.vonage.com/123456789",
                    LinkKind::VonageMeetings,
                ),
                ...
                (
                    "https://us.bbcollab.com/invite/abc123",
                    LinkKind::BlackboardCollab,
                ),
                ("https://join.coscreen.co/abc123", LinkKind::CoScreen),
                ("https://app.vowel.com/#/g/abc123", LinkKind::Vowel),
                (
                    "https://welink.zhumu.com/j/123456?pwd=abc123",
                    LinkKind::Zhumu,
                ),
                ...
                (
                    "https://go.userzoom.com/participate/abc-123",
                    LinkKind::UserZoom,
                ),
                ...
                (
                    "https://app.gather.town/app/abc123/MySpace?spawnToken=xyz",
                    LinkKind::Gather,
                ),
                ("https://meet.pumble.com/my-room", LinkKind::Pumble),
                (
                    "https://my.conference.istesuit.com/room123",
                    LinkKind::SuitConference,
                ),
                ("https://doxy.me/drsmith", LinkKind::DoxyMe),
                ("https://app.cal.com/video/abc123", LinkKind::CalCom),
                ("https://company.zm.page", LinkKind::ZmPage),
                (
                    "https://meet.livekit.io/rooms/my-room-123",
                    LinkKind::LiveKit,
                ),
                (
                    "https://meetings.conf.meetecho.com/ietf123",
                    LinkKind::Meetecho,
                ),
